...
3. **小さい非可換群のLean定理:** `GSH.heightOne_S3` と `GSH.heightOne_D4` は
   全有限 alphabet・全認識準同型・全受理集合を量化したまま証明済み
   （`LEAN-S3-HEIGHT-01`, `LEAN-D4-HEIGHT-01`, 2026-08-01）。
...
| 8 | `Q_8` | nil₂ | **⭕️ 証明完了** — `PST-GRP-02` `CITED`、被覆判定 `COMPUTED` |
