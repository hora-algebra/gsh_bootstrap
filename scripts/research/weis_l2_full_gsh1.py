...
of RESULTS.md section 5 (scripts/research/a4_std_dfa_equivalence.py).
...
def write_certificate(path, expr):
    ...
    data = {
        ...
        "description": (
            ...
            "scripts/research/weis_l2_full_gsh1.py --certificate. Target: the walk "
...
def main():
    ...
    if '--certificate' in sys.argv:
        ...
        print(f"[ok] wrote certificate {path} (check it with "
              f"`python3 scripts/ci/check_certificate.py {path}`, which "
