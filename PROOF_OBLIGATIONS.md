...
| L-RED-001 | Formalize Proposition 3.1 (full-alphabet reduction) via the two §3.5 lemmas: height-preserving Brzozowski derivative and literal-inverse-morphism substitution for generalized expressions. | Lean statements compile; lemma proofs discharge without `sorry`; group lead approves the quantifiers | OPEN |
