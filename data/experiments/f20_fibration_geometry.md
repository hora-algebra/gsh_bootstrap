...
`TRANSD-ABEL-01` (CONJECTURAL).
Obligation: `N-F20-001` stays OPEN; opens route (vi) and registers `N-FIB-PRIOR-001`.
...
Python standard library only. Runtime 24 s. Python 3.14.6, macOS
...
| Artifact | sha256 |
|---|---|
| `scripts/f20_fibration_geometry.py` | `f5a43c2c98841f1a2244a6da02723787562eeea77359b97ee14221cd093cc9e6` |
| stdout of the run | `bea6689bcb70bdc8af78ac998d351c9536654306a2750559de9a150553e9c893` |
...
- **Prior art unsearched.** The decomposition of item 6 looks like a specialisation of
  Straubing's wreath product principle. The repo's derivation is elementary and
  self-contained, so no citation is load-bearing, but novelty must not be claimed.
  Registered as `N-FIB-PRIOR-001`.
