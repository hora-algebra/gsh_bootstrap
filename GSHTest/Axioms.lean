...
/-- info: 'GSH.heightOneForGroup_prod' depends on axioms: [propext, Classical.choice, Quot.sound] -/
#guard_msgs in
#print axioms GSH.heightOneForGroup_prod

/-- info: 'GSH.heightOne_D6' depends on axioms: [propext, Classical.choice, Quot.sound] -/
#guard_msgs in
...
/-- info: 'GSH.heightOne_A4_of_parities' depends on axioms: [propext, Classical.choice, Quot.sound] -/
#guard_msgs in
...
/-- info: 'GSH.isStarFree_a4BaseCutReturnBlock_of_denote' depends on axioms: [propext, Classical.choice, Quot.sound] -/
#guard_msgs in
#print axioms GSH.isStarFree_a4BaseCutReturnBlock_of_denote
